...
// les deux ligne ci dessous genere un confli aec le code 
// qui pilote le PWM
//LS   const byte PIN_BUTTONPRESS =     A0;
//LSconst byte PIN_HAVECONTROLLER = A1;
...
static byte slx, sly, srx, sry;   // declaration des variables pour les manches Left et right
	                                  // mies en globale
...
// mise en memeoire de texte pour affichage.
...
PsxControllerBitBang<PIN_PS2_ATT, PIN_PS2_CMD, PIN_PS2_DAT, PIN_PS2_CLK> psx; // création de psx avec le cablage adequate
boolean haveController = false;    // si le recepteur recois la telecommande 
                                   //   ==> =true
//========================================================================================
void setup () {
	//LS    fastPinMode (PIN_BUTTONPRESS, OUTPUT);
	//LS    fastPinMode (PIN_HAVECONTROLLER, OUTPUT);
...
//	fastDigitalWrite (PIN_HAVECONTROLLER, haveController);
  ...
  {
		if (!psx.read ())   // si l'on arrive pas à lire la telecommande
    {
  ...
  Serial.print("\n   lx: "); Serial.print(getX());
  Serial.print("   ly: "); Serial.print(getY());
  Serial.print("   rx: "); Serial.print(getZ());
}
//========================================================================================

//ls: mse en globale de slX...
byte getX(){  return slx;  }
byte getY(){  return sly;  }
byte getZ(){  return srx;  }
